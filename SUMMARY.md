...
* [Machine Learning Systems - Index](machine-learning-systems/machine-learning-systems-index/README.md)
  * [Accordion: Adaptive Gradient Communication via Critical Learning Regime Identification](machine-learning-systems/machine-learning-systems-index/accordion-adaptive-gradient-communication-via-critical-learning-regime-identification.md)
  ...
  * [Gavel: Heterogeneity-Aware Cluster Scheduling Policies for Deep Learning Workloads](machine-learning-systems/machine-learning-systems-index/gavel-heterogeneity-aware-cluster-scheduling-policies-for-deep-learning-workloads.md)
  * [GPipe: Efficient Training of Giant Neural Networks using Pipeline Parallelism](machine-learning-systems/machine-learning-systems-index/gpipe-efficient-training-of-giant-neural-networks-using-pipeline-parallelism.md)
  * [Is Network the Bottleneck of Distributed Training?](machine-learning-systems/machine-learning-systems-index/is-network-the-bottleneck-of-distributed-training.md)
...
* [Big Data Systems - Index](index/README.md)
  * [From Cloud Computing to Sky Computing](index/from-cloud-computing-to-sky-computing.md)
  * [MapReduce: Simplified Data Processing on Large Clusters](index/mapreduce-simplified-data-processing-on-large-clusters.md)
  * [Mesos: A Platform for Fine-Grained Resource Sharing in the Data Center](index/mesos-a-platform-for-fine-grained-resource-sharing-in-the-data-center.md)
  * [NextDoor: Accelerating graph sampling for graph machine learning using GPUs](index/accelerating-graph-sampling-for-graph-machine-learning-using-gpus.md)
  * [PowerGraph: Distributed Graph-Parallel Computation on Natural Graphs](index/powergraph-distributed-graph-parallel-computation-on-natural-graphs.md)
  * [Pregel: A System for Large-Scale Graph Processing](index/pregel-a-system-for-large-scale-graph-processing.md)
  * [Resilient Distributed Datasets: A Fault-Tolerant Abstraction for In-Memory Cluster Computing](index/resilient-distributed-datasets-a-fault-tolerant-abstraction-for-in-memory-cluster-computing.md)
  * [The Google File System](index/the-google-file-system.md)
* [Cloud Computing Course Notes](cloud-computing-course-notes/README.md)
  * [1.1 Introduction to Clouds, MapReduce](cloud-computing-course-notes/1.1-introduction-to-clouds-mapreduce.md)
  * [1.2 Gossip, Membership, and Grids](cloud-computing-course-notes/1.2-gossip-membership-and-grids.md)
  * [1.3 P2P Systems](cloud-computing-course-notes/1.3-p2p-systems.md)
  * [1.4 Key-Value Stores, Time, and Ordering](cloud-computing-course-notes/1.4-key-value-stores-time-and-ordering.md)
  * [1.5 Classical Distributed Algorithms](cloud-computing-course-notes/1.5-classical-distributed-algorithms.md)
  * [4.1 Spark, Hortonworks, HDFS, CAP](cloud-computing-course-notes/4.1-spark-hortonworks-hdfs-cap.md)
  * [4.2 Large Scale Data Storage](cloud-computing-course-notes/4.2-large-scale-data-storage.md)
